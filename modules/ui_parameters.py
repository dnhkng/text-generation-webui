                ...
                with gr.Column():
                    with gr.Row():
                        with gr.Column():
                            ...
                            shared.gradio['franken_start'] = gr.Number(value=generate_params.get('franken_start', 0), label='Franken Start', info='Cut every X layers when stacking. 0 to disable.')
                            shared.gradio['franken_stop'] = gr.Number(value=generate_params.get('franken_stop', 0), label='Franken Stop', info='Cut length when stacking. 0 to use 2 * Franken Step')
                            shared.gradio['franken_repeats'] = gr.Number(value=generate_params.get('franken_repeats'), label='franken_repeats', info='franken_repeats.')
