                ...
                with gr.Blocks():
                    with gr.Row():
                        ...
                        with gr.Column():
                            ...
                            shared.gradio['franken_layers'] = gr.Textbox(value=shared.args.franken_layers, label='Franken Layers', info='the CLI parameter for the self-frankenlayers. A list of pairs defining the layers.')
